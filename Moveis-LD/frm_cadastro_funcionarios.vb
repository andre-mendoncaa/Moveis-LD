Public Class frm_cadastro_funcionarios
    ...
    Private Sub btn_atualizar_Click(sender As Object, e As EventArgs)
        Dim cpf, nome, senha, acesso, status As String
        cpf = txt_cpf.Text
        nome = txt_nome.Text
        senha = txt_senha.Text
    ...
    Private Sub btn_nova_ficha_Click(sender As Object, e As EventArgs) Handles btn_voltar.Click
        Me.Close()
        frm_menu_gerente.Show()
    End Sub

    Private Sub BunifuThinButton21_Click(sender As Object, e As EventArgs) Handles btn_atualizar.Click
        Dim cpf, nome, senha, acesso, status As String
        cpf = txt_cpf.Text
        nome = txt_nome.Text
        senha = txt_senha.Text
    ...
    Private Sub BunifuThinButton22_Click(sender As Object, e As EventArgs) Handles btn_cadastrar.Click
        Dim cpf, nome, senha, acesso, status As String
        cpf = txt_cpf.Text
        nome = txt_nome.Text
        senha = txt_senha.Text
