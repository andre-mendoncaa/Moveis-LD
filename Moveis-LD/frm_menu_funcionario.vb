...
Public Class frm_menu_funcionario
    ...
    Private Sub btn_alterar_senha_Click(sender As Object, e As EventArgs)
        Me.Close()
    ...
    Private Sub btn_voltar_Click(sender As Object, e As EventArgs) Handles btn_alterar_senha.Click
        Me.Close()
        frm_alterar_senha.Show()
    End Sub

    Private Sub BunifuThinButton21_Click(sender As Object, e As EventArgs) Handles btn_sair.Click
        Me.Close()
        frm_login.Show()
    End Sub
End Class